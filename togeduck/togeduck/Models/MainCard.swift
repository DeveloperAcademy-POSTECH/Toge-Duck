...
extension MainCardData {
    ...
    [
        MainCardData(group_title: "라이딩을 좋아해요", dotimgs: ["dotimg3", "dotimg2", "dotimg3", "dotimg6", "dotimg1"]),
        MainCardData(group_title: "축구를 좋아해요", dotimgs: ["dotimg2", "dotimg5", "dotimg1", "dotimg1", "dotimg5"]),
        MainCardData(group_title: "30분 거리에 있어요", dotimgs: ["dotimg3", "dotimg5", "dotimg3", "dotimg2", "dotimg6"]),
        MainCardData(group_title: "토트넘을 좋아해요", dotimgs: ["dotimg6", "dotimg3", "dotimg3", "dotimg1", "dotimg4"]),
        MainCardData(group_title: "10분 거리에 있어요", dotimgs: ["dotimg4", "dotimg6", "dotimg3", "dotimg2", "dotimg2"]),
